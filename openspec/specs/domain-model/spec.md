...
O resultado de validação SHALL registrar contenção por linha e contenção por valor distinto como métricas separadas, junto das contagens de órfãos correspondentes.
