...
Cada schema SHALL ser medido em três configurações — perfil embarcado sozinho, com detecção de nomenclatura, e com evidência de uso — e o relatório SHALL publicar o recall de cada uma.
...
- **THEN** o relatório traz o recall do perfil sozinho, o com detecção e o com evidência de uso
